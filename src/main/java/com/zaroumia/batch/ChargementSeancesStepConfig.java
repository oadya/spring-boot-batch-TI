...
public class ChargementSeancesStepConfig {
	...
	public FlatFileItemReader<Seance> seanceTxtItemReader(
		...
		return new FlatFileItemReaderBuilder<Seance>()
				...
				.resource(inputFile)
				.fixedLength() // prend un tableu d'interval, chaque interval est l'index de début et fin de la colonne 
	...
	/**
	 * Convertisseur de string vers Localdate
	 * @return
	 */
	@Bean
	...
	/**
	 * FieldSetMapper Mapper chaque colonne vers un attribut de la classe cible
	 * @param myConversionService
	 * @return
	 */
	@Bean
	...
	/**
	 * Sauvegarder les séances lues en csv ou txt
	 */
	@Bean
	...
	/**
	 *  Step de chargement chargementSeancesCsvStep
	...
	/**
	 * Step de chargement chargementSeancesTxtStep
	 * @param stepBuilderFactory
	 * @return
	 */
	@Bean
